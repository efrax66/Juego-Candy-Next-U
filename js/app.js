...
// Animacion que cambia el color del titulo
var juegoDulces = {
...
// Funcion que  aparacen nuevos candys en un intervalo de 0.2 segundos
	$(".elemento").droppable({
...
// Cambia el Tablero de Juego por el Panel del Score
function gameOver(){
